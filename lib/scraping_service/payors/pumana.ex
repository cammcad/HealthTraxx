defmodule ScrapingService.Payors.Pumana do
    @moduledoc false
    use GenServer
    require Logger
    ...
    def handle_cast({:scrape, %Procedure{procedure_name: procedure_name}}, state) do
      case Facilitator.is_procedure_supported_by_payor?(%PayorProcedure{payor_name: "pumana", procedure_name: procedure_name}) do
        :not_supported -> Logger.info "Procedure: #{inspect(procedure_name)} not supported by Pumana"
